...
This document provides guidelines for internationalization of the Anodos Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ands_en.ts` remains unchanged.
