...
This mechanism has been integrated into Bitcore-Node-Anodos which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/andspay/insight-api-ands#web-socket-api](https://github.com/andspay/insight-api-ands#web-socket-api)
* API: [https://github.com/andspay/insight-api-ands#instantsend-transactions](https://github.com/andspay/insight-api-ands#instantsend-transactions)
...
By default, the Anodos Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Anodos Core daemon:
