...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Anodos address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "ands",               "masternode",             &masternode,             true,  {} },
    { "ands",               "masternodelist",         &masternodelist,         true,  {} },
    { "ands",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "ands",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "ands",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "ands",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
