...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Anodos related functionality
...
/*
    ...
    allow endless transaction that would bloat Anodos and make it unusable. To
