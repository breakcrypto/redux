    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ANDS-light"), QVariant("light"));
    ui->theme->addItem(QString("ANDS-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("ANDS-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("ANDS-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("ANDS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ANDS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ANDS-traditional"), QVariant("trad"));
