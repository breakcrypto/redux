    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  ands-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Anodos in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ANDS, 0.1 ANDS, 1 ANDS and 10 ANDS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://andspay.atlassian.net/wiki/display/DOC/PrivateSend\">https://andspay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
