# Linearize
Construct a linear, no-fork, best version of the Anodos blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install ands_hash

https://github.com/andspay/ands_hash
...
JSON-RPC server. Running `andsd` or `ands-qt -server` will be sufficient.
...
* `input`: andsd blocks/ directory containing blkNNNNN.dat
